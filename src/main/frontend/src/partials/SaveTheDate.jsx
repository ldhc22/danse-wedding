...
const deadline = "12 Jun 2022 00:00:00 GMT";

function SaveTheDate(props) {
  return (
    <section className="relative" ref={props.dateRef}>
      <div className=" bg-danse-green-125" data-aos="zoom-y-out">
        <div className="pt-24 md:pt-28 flex flex-col items-center transition duration-300 ease-in-out">
          ...
          <div className=" items-center text-center ">
            <p className="text-xl text-danse-green-500 font-bold p-6">
              Sábado 11 de junio de 2022 a las 7:00 pm
            </p>
